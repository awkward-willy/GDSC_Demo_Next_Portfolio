  ...
  return (
    <>
      ...
      <div className="flex flex-row flex-wrap justify-evenly items-center h-[90vh]">
        <Image src={profilePic} alt="ProfilePicture" className="pt-4 m-4 w-[30vw] min-w-[250px] max-w-[400px]" />
        <div className="flex flex-col m-4">
          ...
          <div className="mt-4 flex flex-col leading-10">
            <a href="/about" className="text-2xl text-slate-700 before:content-['👉'] hover:after:content-['_-Click_to_GO!_🚀']">About Me</a>
            <a href="/experience" className="text-2xl text-slate-700 before:content-['👉'] hover:after:content-['_-Click_to_GO!_🚀']">Experience</a>
          </div>
        </div>
      </div>
    </>
